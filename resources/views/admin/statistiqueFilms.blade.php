...
<body class="bg-[#111111]">
    ...
    <div class="flex">
        <div class=" md:w-[25%] mr-auto">
            @include('layouts.sideBarAdmin')
        </div>
        <div>
            <u class="text-white ml-2">
                <h1 class=" text-white font-semibold text-lg ml-28">Films of the week</h1>
            </u>

            <form action="/addFilmWeek" method="POST" enctype="multipart/form-data" class="bg-[#111111] text-white flex justify-center w-full  shadow-lg rounded pt-6 mt-10 md:mx-8 mb-4">
                @csrf
                <div class="grid md:grid-cols-2 grid-cols-1 gap-4">
                    <div class="mb-4">
                        <label for="film_id" class="block text-sm font-bold mb-2">Movie Title:</label>
                        <select name="film_id" id="film_id" required class="bg-gray-800 appearance-none rounded w-full py-4 px-3 text-white leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <div class="mb-4">
                        <label for="presentation_time" class="block text-sm font-bold mb-2">Show Time:</label>
                        <select name="presentation_time" id="presentation_time" required class="bg-gray-800 appearance-none rounded w-full py-4 px-3 text-white leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="salle_id" id="salle_id" required class="bg-gray-800 appearance-none rounded w-full py-4 px-3 text-white leading-tight focus:outline-none focus:shadow-outline">
            ...
            <u class="text-white ml-8">
                <h1 class=" text-white font-semibold text-lg ml-28">Management Movies</h1>
            </u>

            <div
                class="md:w-[95%] ml-auto overflow-x-auto overflow-y-scroll w-full mt-8  md bg-white p-4 shadow rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="runtime" name="runtime" required
                            value="{{ $filmEdit ? $filmEdit->runtime : '' }}"
                            class="bg-gray-800 appearance-none  rounded w-full py-4 px-3 text-white leading-tight focus:outline-none focus:shadow-outline">
                    </div>
